...
| 4 | `challenge4/` | Motor de clasificación con LLM + redacción de PII | ✅ pytest → 41 passed + eval offline + ✅ demo en vivo |
...
│  ├─ README.md                #    punto de entrada del subproyecto (pipeline y uso)
│  ├─ classifier/              #    paquete: redaction, prompts, llm_client, classify, config, models, batch, cli
...
- **Verificado localmente:** todas las suites pytest (C1 13, C2 9 mock, C4 41 — 8 clasificador +
  26 redacción + 7 config), guardas de firma, import sin side effects, eval offline de C4, y C3
